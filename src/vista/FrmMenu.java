...
import javax.swing.*;
import controlador.ActivityTimer;
...
public class FrmMenu extends javax.swing.JFrame {
    ...
    public FrmMenu() {
        ...
        activityTimer = new ActivityTimer(this::redirectToLogin);
        activityTimer.start();
        
        // Agregar un listener para la actividad del mouse
        ...
        // Agregar un listener para la actividad del teclado
    ...
    private void resetTimer() {
        activityTimer.reset(); // Reiniciar el temporizador
        System.out.println("Actividad detectada. Temporizador reiniciado.");
    }
    ...
    private void redirectToLogin() {
        ...
        SwingUtilities.invokeLater(() -> {
            FrmLogin loginFrame = new FrmLogin(); // Crear una nueva instancia de FrmLogin
            loginFrame.setVisible(true); // Asegurarse de que la ventana de inicio de sesión sea visible
        });
    }
