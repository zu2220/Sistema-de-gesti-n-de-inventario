...
public class InterGraficas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jDateChooser_fecha_inicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 110, -1));

        jDateChooser_fecha_fin.setDateFormatString("yyyy-MM-dd\n");
        getContentPane().add(jDateChooser_fecha_fin, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 110, -1));

        jPanel2.setBackground(new java.awt.Color(153, 51, 255));
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 440, 260));
