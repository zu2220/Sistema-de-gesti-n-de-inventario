...
public class InterCategoria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1_wallpaper.setForeground(new java.awt.Color(102, 102, 255));
        jLabel1_wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondo22.png"))); // NOI18N
        ...
        getContentPane().add(jLabel1_wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 200));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txt_descripcion.getText().isEmpty()) {
            ...
            if (!controlCategoria.existeCategoria(txt_descripcion.getText().trim())) {
                ...
                JOptionPane.showMessageDialog(null, "Ya existe la categoria");
            }
