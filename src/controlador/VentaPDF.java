...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            // Agregar el Tipo de Recojo
            Paragraph tipoRecojoParrafo = new Paragraph();
            tipoRecojoParrafo.add(Chunk.NEWLINE);
            tipoRecojoParrafo.add("Tipo de Recojo: " + tipoRecojo + "\n\n");
            doc.add(tipoRecojoParrafo);
